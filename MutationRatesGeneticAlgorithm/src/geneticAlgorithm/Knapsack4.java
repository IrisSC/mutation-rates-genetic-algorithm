...
public class Knapsack4 extends Knapsack{
	/*
	 * Knapsack4 constructor
	 * sets the cap, max values, weights, and values of this Knapsack Problem
	 */
	public Knapsack4() {
		this.cap = 1173;
		this.maxValue = 5183;
		int[] weights = {40, 27, 5, 21, 51, 16, 42, 18, 52, 28, 57, 34, 44, 43, 52, 55, 53,
		...
		int[] values = {199, 194, 193, 191, 189, 178, 174, 169, 164, 164, 161, 158, 157,
