...
public class Knapsack5 extends Knapsack{
	/*
	 * Knapsack5 constructor
	 * sets the cap, max values, weights, and values of this Knapsack Problem
	 */
	public Knapsack5() {
		this.cap = 3818;
		this.maxValue = 15170;
		int[] weights = {54, 95, 36, 18, 4, 71, 83, 16, 27, 84, 88, 45, 94, 64, 14, 80, 4, 23,
		...
		int[] values = {297, 295, 293, 292, 291, 289, 284, 284, 283, 283, 281, 280, 279,
